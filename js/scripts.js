...
paceOptions = {
    ajax: true,
    document: true,
    eventLag: false, // Disabling event lag might speed up the preloader
    restartOnRequestAfter: false, // Disable restarting on every AJAX request
    restartOnPushState: false, // Disable restarting when pushState is used for navigation
    restartOnBackboneRoute: false, // Disable restarting when a Backbone route changes
    elements: {
        selectors: ['.loading-text'] // Specify elements to track for loading progress
    }
};
